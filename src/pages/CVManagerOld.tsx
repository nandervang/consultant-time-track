...
import { useEnhancedProjects, useEnhancedExperiences, useTechnologyTags } from '@/hooks/useEnhancedCV';
...
export default function CVManager() {
  ...
  const [selectedTemplate, setSelectedTemplate] = useState<any>(null); // TODO: Import proper CV template type
  ...
  // Remove achievements hook entirely as it's not used
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <Button 
            ...
            disabled={!profiles.find(p => p.is_active)}
          >
                  ...
                  <div className="grid gap-6">
                    {enhancedExperiences.map((experience) => (
                      <EnhancedExperienceCard
                        ...
                        onEdit={() => {/* TODO: Add edit handler */}}
                        onDelete={deleteExperience}
                        onAddAchievement={() => {/* TODO: Add achievement handler */}}
                      />
                    ))}
                  </div>
                )}
      ...
      <CVEditorModal
        open={showCVEditor}
        onOpenChange={setShowCVEditor}
        profile={profiles.find(p => p.is_active) || null}
      />
    </div>
  );
}
