...
ADD COLUMN IF NOT EXISTS debit_rate_monthly DECIMAL(5,2) DEFAULT 94,
ADD COLUMN IF NOT EXISTS absence_percentage DECIMAL(5,2) DEFAULT 15,
...
-- Add comments
COMMENT ON COLUMN user_profiles.debit_rate_monthly IS 'Billing percentage - percentage of work hours that are actually billable (e.g. 94%)';
